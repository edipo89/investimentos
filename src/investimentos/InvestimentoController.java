...
public class InvestimentoController {
    ...
    private String screen = "Simulador";
    ...
    private CDB cdb() {
        ...
        double taxa = Money.porcentagemToDouble(txt1.getText());
    ...
    protected void initialize() {
        ...
        txtValorInicial.setText(Money.doubleToMoney(1000));
        txt1.setText("100,00");
        txtAporte.setText(Money.doubleToMoney(100));

        dataInicial.setValue(LocalDate.of(LocalDate.now().getYear(), LocalDate.now().getMonth(), LocalDate.now().getDayOfMonth()));
        dataFinal.setValue(LocalDate.of(LocalDate.now().getYear() + 1, LocalDate.now().getMonthValue(), LocalDate.now().getDayOfMonth()));
        ...
        switch (screen) {
            ...
            case "Simulador":
                ...
                lblAux1.setText("Total (CDB / LCA / LCI):");
                lblAux2.setText("Total (Poupança):");
                lblTaxa.setText("Taxa de Juros %a.a (Poupança):");
                lbl1.setText("Taxa de Juros %a.a (CDB / LCA / LCI):");
                ...
                txt1.setTooltip(new Tooltip(
                        "A taxa de juros de aplicações CDB / LCA / LCI é a taxa DI, pode ser consultada no site da CETIP \n(https://www.cetip.com.br/)"));
                txt2.setTooltip(new Tooltip(
                        "Determina qual a proporção da taxa DI que será aplicada no rendimento da aplicação"));
                lblAux1Desc.setTooltip(new Tooltip("Valor total já com o rendimento do CDB / LCA / LCI"));
                lblAux2Desc.setTooltip(new Tooltip("Valor total já com o rendimento da poupança"));
                lblAux3Desc.setTooltip(new Tooltip("Valor do rendimento do CDB / LCA / LCI (Total - Total investido)"));
                ...
                txtJuros.setText("4,45");
                txt1.setText("6,12");
                txt2.setText("100,00");
                lineChart.setTitle("Simulador");
    ...
    private void salvarGrafico() {
        Scene scene = pane.getScene(); //Obtendo a janela atual
        ...
        chooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Save file (*.png)", "*.png"));
    ...
    private void simular() {
        ...
        if (txtValorInicial.getText().isEmpty()
                || txtAporte.getText().isEmpty()
                || txtJuros.getText().isEmpty()
                || ((screen.equals("Simulador")) && txt1.getText().isEmpty())
                || (screen.equals("Simulador") && txt2.getText().isEmpty())) {
